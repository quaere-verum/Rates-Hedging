...
from _bermudan_hedging_common import (
...
def main() -> None:
    ...
    path_summary_path = artifact_dir / "bermudan_model_misspecification_pnl_breakdown_paths.csv"
    time_summary_path = artifact_dir / "bermudan_model_misspecification_pnl_breakdown_time.csv"
    risk_summary_path = artifact_dir / "bermudan_model_misspecification_pnl_breakdown_risk.csv"
    plot_path = artifact_dir / "bermudan_model_misspecification_pnl_breakdown.png"
    ...
    make_plot(
        ...
        title="Bermudan Swaption Delta Hedging Under Model Misspecification",
    ...
    print(
        final_pnl_summary[
            ["model", "pricing_model", "real_dynamics", "mean", "std", "var_95_loss", "cvar_95_loss", "cvar_99_loss"]
        ]
        .round(2)
