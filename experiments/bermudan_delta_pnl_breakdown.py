...
def main() -> None:
    ...
    path_summary_path = artifact_dir / "bermudan_delta_pnl_breakdown_paths.csv"
    time_summary_path = artifact_dir / "bermudan_delta_pnl_breakdown_time.csv"
    risk_summary_path = artifact_dir / "bermudan_delta_pnl_breakdown_risk.csv"
    plot_path = artifact_dir / "bermudan_delta_pnl_breakdown.png"
    ...
    make_plot(
        ...
        title="Bermudan Swaption Delta Hedging PnL Breakdown",
